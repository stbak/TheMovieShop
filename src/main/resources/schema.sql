...
ALTER TABLE [Order] ADD FOREIGN KEY (MemberId) REFERENCES Member(MemberId);
ALTER TABLE [Order] ADD FOREIGN KEY (MovieId) REFERENCES Movie(MovieId);
CREATE INDEX IDX_RES_DATE_ ON ORDER(OrderDate);
